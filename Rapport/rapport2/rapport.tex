...
% //Note pas compirs pourquoi 2,3 puis 50/50..
...
L'ex\'ecution de la commande perf stat a pris 5.477 secondes et l'ex\'ecution de la commande time a pris 5.07 secondes. Mais il faudrait effectuer plusieurs\
% //note ? milieur de la phrase 
lancements ps\ lancementsune moyenne plus pr\'ecise.
...
blabla beaucoup blabla robot qui roule sur les gros 
